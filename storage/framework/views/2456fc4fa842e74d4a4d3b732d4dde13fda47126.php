<!-- REQUIRED SCRIPTS -->
<script src="<?php echo e(asset('admin-panel/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('admin-panel/js/sweetalert.min.js')); ?>"></script>
...
<script>
    function countdowntimes() {
        ...
        document.getElementById('preview').innerHTML =
            // h + ":" + m + ":" + s;
            livedt.toLocaleString('en-PK', { timeZone: '<?php echo e($curr_timezone); ?>' });
...
<?php /**PATH D:\xampp\htdocs\kingdom_vision_pro_2\resources\views/admin/layouts/includes/footer.blade.php ENDPATH**/ ?>