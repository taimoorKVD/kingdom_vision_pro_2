    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?php echo e(route('login')); ?>" class="h1"><b><?php echo e(config('app.name')); ?></b></a>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php endif; ?>
                <p class="mb-0">
                    <a href="<?php echo e(route('register')); ?>" class="text-center">Don't have account? Sign Up</a>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
...
<?php /**PATH D:\xampp\htdocs\kingdom_vision_pro_2\resources\views/auth/login.blade.php ENDPATH**/ ?>